...
class ViewController: UIViewController {
  ...
  /// Handle a tap where the correct login was used.  We are hard coding the
  /// values here, so we know what should happen.  This will be successfull.
  ...
  /// Handle a tap where the login is incorrect.  We are hard coding the values
  /// here so we know it should fail.
